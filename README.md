...
| ホーム | 防災マップ (ハザード重畳) |
|---|---|
| ![ホーム画面 — 気象警報・地震バナー、防災への近道、各機能カード](docs/images/home.png) | ![防災マップ — 避難所・給水拠点・AED とハザードタイル重畳のレイヤパネル](docs/images/disaster-map.png) |
| **区民マップ** | **ごみ収集カレンダー** |
| ![区民マップ — AED・公園・駅・病院などのピンを低ズームでクラスタリング](docs/images/civic-map.png) | ![ごみ収集カレンダー — 当日/翌日・今週の収集・月次カレンダー](docs/images/gomi-calendar.png) |
| **バス時刻表 (路線図)** | **バス時刻表 (検索)** |
